...
public class DogImageAdapter extends RecyclerView.Adapter<DogImageAdapter.ViewHolder>{
    ...
    public DogImageAdapter(Context dogImageActivity, List<String> mDogImageList) {
        this.context = dogImageActivity;
        this.mList = mDogImageList;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            imageView = (ImageView) itemView.findViewById(R.id.iv_dog);
